...
export function ReadingCoverCard({ date, title, theme, keywords = [], message }: ReadingCoverCardProps) {
  return (
    ...
    >
      {/* 枠線（4辺連続・1px・ゴールド/30 の控えめな線。線なしエンブレムが下辺の上に乗る） */}
      <span className="pointer-events-none absolute inset-[8px] rounded-md border border-gold/30" />
      ...
      <div className="relative z-10 flex flex-col items-center px-6 pb-10 pt-28 text-center">
        {/* ヘッダー */}
